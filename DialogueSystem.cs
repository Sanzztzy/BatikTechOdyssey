...
public class DialogueSystem : MonoBehaviour
{
    ...
    DialogueContainer questDialogue;
    int currentTextLine;
    ...
    public void Initialize(DialogueContainer dialogueContainer){
        ...
        questDialogue = dialogueContainer;
        currentTextLine = 0;
    ...
    private void CheckQuest(){
        ...
        if(questDialogue is DialogueQuest){

            DialogueQuest dq = questDialogue as DialogueQuest;
            QuestManager.instance.SetQuest(dq.quest);
        }
    }
